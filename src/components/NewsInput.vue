        ...
        <v-container full-height fluid>
            ...
            <v-row justify="center" >
                <v-col md="6" class="myform pa-10" justify="center">
                    ...
                    <v-row class="mt-10 mb-4"><h2 class="mytext white--text">新聞來源</h2>
                    ...
                    <span id="must_fill3" style="color:white;font-size:14px;">&nbsp(必填)</span>
                    </v-row>
...
export default {
    ...
    methods: {
        submit() {
            if(this.title != "" && this.source != "" && this.content != ""){
            ...
            else document.getElementById("must_fill").setAttribute("style","color:white;font-size:14px;");
            if(this.source == "") document.getElementById("must_fill2").setAttribute("style","color:red;font-size:14px;");
            else document.getElementById("must_fill2").setAttribute("style","color:white;font-size:14px;");
            if(this.content == "") document.getElementById("must_fill3").setAttribute("style","color:red;font-size:14px;");
            else document.getElementById("must_fill3").setAttribute("style","color:white;font-size:14px;");
        }    
    }
